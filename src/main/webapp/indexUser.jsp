			...
			<div class="col-lg-3 d-none d-lg-block">
				...
				<nav
					...
					<div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
						...
						<a href="ZingServlet" class="nav-item nav-link">ZING</a> <a
							href="VCoinServlet" class="nav-item nav-link">VCOIN</a> <a
							href="GarenaServlet" class="nav-item nav-link">GARENA</a> <a
							href="GateServlet" class="nav-item nav-link">GATE</a> <a
							href="VGPlayServlet" class="nav-item nav-link">VGPLAY</a>
					</div>
				</nav>
			</div>
			<div class="col-lg-9">
		...
		<div class="row px-xl-5 pb-3">
			...
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					style="padding: 30px;">
					<p class="text-right">6 Sản phẩm</p>
					<a href="VGPlayServlet"
						class="cat-img position-relative overflow-hidden mb-3"> <img
						class="img-fluid" src="Images/vendor-8.jpg" alt="">
					</a>
