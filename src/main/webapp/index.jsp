			...
			<div class="col-lg-3 d-none d-lg-block">
				...
				<nav
					...
					<div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
						...
						<a href="login.jsp" class="nav-item nav-link">ZING</a> <a
							href="login.jsp" class="nav-item nav-link">VCOIN</a> <a
							href="login.jsp" class="nav-item nav-link">GARENA</a> <a
							href="login.jsp" class="nav-item nav-link">GATE</a> <a
							href="login.jsp" class="nav-item nav-link">VGPLAY</a>
					</div>
				</nav>
			</div>
			<div class="col-lg-9">
					...
					<div class="collapse navbar-collapse justify-content-between"
						...
						<div class="navbar-nav mr-auto py-0">
							<a href="index.jsp" class="nav-item nav-link active">Trang
								chủ</a> <a href="login.jsp" class="nav-item nav-link">Giỏ hàng</a> <a
								href="login.jsp" class="nav-item nav-link">Liên hệ</a>
						</div>
						<div class="navbar-nav ml-auto py-0">
							<a href="login.jsp" class="nav-item nav-link">Đăng nhập</a> <a
								href="register.jsp" class="nav-item nav-link">Đăng ký</a>
						</div>
					</div>
				</nav>
			...
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					...
					<a href="login.jsp"
						...
						class="img-fluid" src="Images/vendor-1.jpg" alt="">
					</a>
					<h5 class="font-weight-semi-bold m-0">Thẻ Zing</h5>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					...
					<a href="login.jsp"
						class="cat-img position-relative overflow-hidden mb-3"> <img
						class="img-fluid" src="Images/vendor-3.jpg" alt="">
					</a>
					<h5 class="font-weight-semi-bold m-0">Thẻ Garena</h5>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					...
					<a href="login.jsp"
						class="cat-img position-relative overflow-hidden mb-3"> <img
						class="img-fluid" src="Images/vendor-4.jpg" alt="">
					</a>
					<h5 class="font-weight-semi-bold m-0">Thẻ VCoin</h5>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					...
					<a href="login.jsp"
						class="cat-img position-relative overflow-hidden mb-3"> <img
						class="img-fluid" src="Images/vendor-2.jpg" alt="">
					</a>
					<h5 class="font-weight-semi-bold m-0">Thẻ Gate</h5>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					style="padding: 30px;">
					<p class="text-right">6 Sản phẩm</p>
					<a href="login.jsp" class="cat-img position-relative overflow-hidden mb-3">
						<img class="img-fluid" src="Images/vendor-8.jpg" alt="">
					</a>
					<h5 class="font-weight-semi-bold m-0">Thẻ VGPlay</h5>
				</div>
			</div>
						...
						<div class="col-md-4 mb-5">
							...
							<div class="d-flex flex-column justify-content-start">
								<a class="text-dark mb-2" href="index.jsp"
									...
									<i class="fa fa-angle-right mr-2"></i>>Giỏ hàng</a> <a
									class="text-dark mb-2" href="contact.jsp"
									class="nav-item nav-link"
