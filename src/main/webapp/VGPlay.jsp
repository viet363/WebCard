	...
	<div class="container-fluid">
		...
		<div class="row align-items-center py-3 px-xl-5">
			<div class="col-lg-3 d-none d-lg-block">
				<a href="indexUser.jsp" class="text-decoration-none">
				...
				<div id="header-carousel" class="carousel slide"
					...
					<div class="col-lg-9 col-12">
						...
						<table class="table table-striped">
							...
							<tbody>
								<c:forEach var="product" items="${VGPlayServlet}">
									<tr>
										<td>${product.id}</td>
										<td>${product.name}</td>
										<td>${product.type}</td>
										<td>${product.price}</td>
										<td><a href="#" class="btn btn-primary btn-sm">Mua</a> <a
											href="#" class="btn btn-primary btn-sm">Thêm vào giỏ hàng</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
